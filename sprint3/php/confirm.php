...
<div class="container container-bg">
 ...
 <div class="row">
         ...
         <div class="row">
          ...
          <a id="button" class="btn btn-danger btn-lg" href="/sprint3/questionnaire.html" role="button">Back to Form</a>
          </div>
          
          <div class="col-6 text-center">
            <form name="questionnaire" method="post" action="/sprint3/php/receipt.php">';
    ...
    //         $result = @mysqli_query($cnxn, $sql);
        ...
        echo '<div class="col d-flex justify-content-center">
              <div class="card p-lg-5 m-lg-5 shadow-lg p-3 mb-5 bg-white rounded" style="width: 30em; height: 40em; border-radius: 5%">
                ...
                <div class="row">
                  <div class="col-lg-12 text-center">
                  <a id="button" class="btn btn-success btn-lg" href="/sprint3/questionnaire.html" role="button">Back to Form</a>
                  </div>
                </div>
              </div>
              </div>';
